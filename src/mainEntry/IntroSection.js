...
function IntroSection() {
  return (
    <div className="intro-section">
          ...
          <h2 className="intro-subheader">Accessibility Expert, Developer</h2>
          ...
          <p>I have been and am constantly building my skillset, and I am a perpetual learner. My goal is to produce high quality, maintainable code. I am also interested in testing and I am ISTQB certified at the foundation level. I always design "mobile-first". Checkout my code yourself, source code for this page and all of the demo pages can be found on this<a target="blank" rel="noreferrer" href="https://github.com/Leddfoot"> Github Link</a>.   </p>
